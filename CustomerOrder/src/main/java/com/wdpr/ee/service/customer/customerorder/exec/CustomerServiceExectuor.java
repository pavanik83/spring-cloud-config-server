...
public class CustomerServiceExectuor {
	...
	//@WdprMethodLog
	public void createCustomer(Customer customer) throws ClassNotFoundException, SQLException, IOException, Exception {
	...
	public void createCustomerOrder(CustomerOrder customerOrder) throws ClassNotFoundException, SQLException, IOException {
