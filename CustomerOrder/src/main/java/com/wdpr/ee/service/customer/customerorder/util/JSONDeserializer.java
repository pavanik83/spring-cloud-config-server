...
* Desc:  class used for VA JSON Deserialization using jakson ObjectMapper.
* (c) Disney. All rights reserved.
*
* $Author: cognizant $nixon
* $Revision:  $
* $Change:  $
* $Date: $
********************************************************************************************************/
...
public class JSONDeserializer {
    ...
    JSONDeserializer() {
        ...
        mapper.configure(DeserializationConfig.Feature.AUTO_DETECT_SETTERS,
                true);
...
//            throw new ConfigurationException("The input is not valid JSON", ex);
            ...
            LOGGER.error(ex);
//            throw new ConfigurationException("The input JSON doesn't match ", ex);
...
//             throw ApplicationExceptionFactory.create(HttpErrorType.INTERNAL_SERVER_ERROR, ErrorTypeEnum.SYSTEM_ERROR,
//                        ProductErrorCode.JSON_RESPONSE_PARSING_ERROR , "JsonParseException " );

        } catch (JsonMappingException e) {

            LOGGER.error(e);
//             throw ApplicationExceptionFactory.create(HttpErrorType.INTERNAL_SERVER_ERROR, ErrorTypeEnum.SYSTEM_ERROR,
//                        ProductErrorCode.JSON_RESPONSE_PARSING_ERROR , "JsonMappingException " );
...
//             throw ApplicationExceptionFactory.create(HttpErrorType.INTERNAL_SERVER_ERROR, ErrorTypeEnum.SYSTEM_ERROR,
//                        ProductErrorCode.JSON_RESPONSE_PARSING_ERROR , "Unable to load Object " );
        }
...
//
//             throw ApplicationExceptionFactory.create(HttpErrorType.INTERNAL_SERVER_ERROR, ErrorTypeEnum.SYSTEM_ERROR,
//                        ProductErrorCode.JSON_RESPONSE_PARSING_ERROR , "toJSONString() JsonParseException " );
//
//        } catch (IOException e) {
...
//
//
//    public static String toJSONString(ProductsResourceCollectionVO resCollection) {
//        String jsonString = null;
//        try {
//            long time = System.currentTimeMillis();//TODO: remove
//            jsonString = mapper.writeValueAsString(resCollection);
//            LOGGER.info("Time toJSONString ()"+(System.currentTimeMillis()-time));//TODO: remove
//        } catch (IOException e) {
//            LOGGER.error(e.getLocalizedMessage(), e.fillInStackTrace());
//        }
//
//        if (jsonString == null) {
//            throw ApplicationExceptionFactory.create(HttpErrorType.INTERNAL_SERVER_ERROR,
//                    ErrorTypeEnum.INVALID_FORMAT,
//                    ProductErrorCode.JSON_RESPONSE_PARSING_ERROR,
//                    "Serialization Issue");
//        }
