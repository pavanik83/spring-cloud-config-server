...
public class CustomerOrder extends Order
{
    ...
    // params.getFirst(paramName.toString())!=null)
    // this.setShippingAddressId(params.getFirst(paramName.toString()));
    // if(paramName.toString().equals("itemNumberAndQuantity") &&
    // params.getFirst(paramName.toString())!=null)
    // {
    ...
    // catch(Exception e){
    // throw new
    // IllegalArgumentException("Illegal values passed while passing order", new
    // Exception("Missing shipping address/customer id/item number"));
    // }
    //
    //
    //
