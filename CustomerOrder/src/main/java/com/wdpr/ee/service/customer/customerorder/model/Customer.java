    ...
    public Customer(MultivaluedMap<String, String> params)
    {
        ...
        if (params != null)
        {
            ...
            for (paramOption paramName : CustomerServiceOption.paramOption.values())
            {
                ...
                {
                    throw new IllegalArgumentException("Illegal values for Zip code",
                            new Exception("Invalid Params"));
                }

            }
            if (address.getFirstAddressLine() != null && address.getCity() != null
                    && address.getZip() != null)
            ...
            if (this.firstName == null || this.lastName == null)
            {
                ...
                throw new IllegalArgumentException(
                        "Illegal values for first name and/or last name", new Exception(
                                "Invalid Params"));
            }
