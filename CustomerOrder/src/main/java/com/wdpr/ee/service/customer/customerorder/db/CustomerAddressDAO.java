...
public class CustomerAddressDAO extends CustomerDAO
{
    ...
    private PreparedStatement populateAddressValues(Customer customer, PreparedStatement statement)
            throws SQLException
    {
    ...
    @WdprMethodLog
    public boolean validateCustomerAddressId(String customerId, String shippingAddressId)
