...
public class CustomerDAO {
	...
	public void loadCustomer(Customer customer) throws SQLException, ClassNotFoundException, IOException, Exception {
	...
	private static void loadCustomerDetails(Customer customer)
		...
		try
		{
			...
			logging.info("Total_time_PS_loadCustomer : taken to execute loadCustomer query:="+TimeUnit.MILLISECONDS.convert((queryEndTime-queryStartTime), TimeUnit.NANOSECONDS));
	...
	private static PreparedStatement populateValues(Customer customer,
